    ...
    public Dto<Object> getImgByTargetId(@ApiParam(required = true, name = "targetId", value = "评论ID")
        ...
        if(null != targetId && !"".equals(targetId)){
            ...
            try {
                ...
                System.out.println(itripImageVOList+"22222");
                        ...
                        try{
                            ...
                            if(file != null){
                                ...
                                if(myFileName.trim() !=""
                                    ...
                                    //定义上传路径
                                    String path = (systemConfig.getFileUploadPathString() + File.separator +fileName).replace("\\","/");
                                    System.out.println(path+"1111111111");
